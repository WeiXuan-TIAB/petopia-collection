...
export default function CardReptile() {
  return (
    <div className="w-[150px] h-40 px-2 inline-flex justify-start items-end gap-2.5 group cursor-pointer">
      <div className="flex-1 inline-flex flex-col justify-start items-center">
        ...
        inline-flex justify-center items-end -mt-[130px]">
          <div className="text-center justify-start text-white text-xl font-normal font-['FakePearl'] leading-loose">爬蟲專區</div>
        </div>
      </div>
    </div>
  )
