...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p><a href="${serverConfig.nextUrl}/member/forget-password-2p/reset?secret=${secret}" target="_blank">重設登入密碼頁面連結</a></p>
...
<http://localhost:3000/member/forget-password-2p/reset?secret=${secret}>
