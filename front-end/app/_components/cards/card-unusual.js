...
export default function CardUnusual() {
  return (
    <div className="w-[150px] h-40 px-2 inline-flex justify-start items-end gap-2.5 group cursor-pointer order-4 md:order-3">
      <div className="flex-1 inline-flex flex-col justify-start items-center">
        <Image 
        width={124} 
        height={90} 
        className="relative z-10 w-auto h-auto" 
        src="/images/animal_svg/鳥.svg" 
        alt="特寵專區"
        unoptimized
        priority
        />
        ...
        inline-flex justify-center items-end -mt-[90px]">
          <div className="text-center justify-start text-white text-xl font-normal font-['FakePearl'] leading-loose">特寵專區</div>
        </div>
      </div>
    </div>
  )
